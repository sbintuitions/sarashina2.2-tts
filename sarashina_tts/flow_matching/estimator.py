# Flow matching estimator components.
# Ported from FlashCosyVoice (https://github.com/xingchensong/FlashCosyVoice)
...
from .upsample_encoder import add_optional_chunk_mask
...
class CausalConditionalDecoder(ConditionalDecoder):
    ...
    def forward(self, x, mask, mu, t, spks=None, cond=None, streaming=False):
        ...
        Args:
            ...
            spks (_type_, optional): shape: (batch_size, condition_channels). Defaults to None.
            cond (_type_, optional): placeholder for future use. Defaults to None.
            streaming (bool): whether in streaming mode. Defaults to False.

        Returns:
            torch.Tensor: predicted velocity field, shape (batch_size, out_channels, time)
        """
        t = self.time_embeddings(t).to(t.dtype)
        t = self.time_mlp(t)
